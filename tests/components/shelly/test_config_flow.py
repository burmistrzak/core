...
async def test_form_enhanced_security_with_https_port(
    ...
    """Test manual setup with enhanced_security and device reports HTTPS port."""
    result = await hass.config_entries.flow.async_init(
        DOMAIN, context={"source": config_entries.SOURCE_USER}
    )
    assert result["type"] is FlowResultType.FORM
...
async def test_zeroconf_enhanced_security(
    ...
    """Test zeroconf discovery with enhanced_security keeps discovered port."""
    with patch(
        "homeassistant.components.shelly.config_flow.get_info", return_value=get_info
    ):
        result = await hass.config_entries.flow.async_init(
...
async def test_zeroconf_enhanced_security_with_https_port(
    ...
    """Test zeroconf discovery with enhanced_security and device reports HTTPS port."""
    with patch(
        "homeassistant.components.shelly.config_flow.get_info", return_value=get_info
    ):
        result = await hass.config_entries.flow.async_init(
...
async def test_reauth_enhanced_security(
    ...
    """Test reauth flow with enhanced_security keeps original port."""
    entry = MockConfigEntry(
        domain=DOMAIN,
        unique_id="test-mac",
...
async def test_reconfigure_enhanced_security(
    ...
    """Test reconfigure flow with enhanced_security keeps original port."""
    entry = MockConfigEntry(
        domain=DOMAIN,
        unique_id="test-mac",
